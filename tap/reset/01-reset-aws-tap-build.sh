...
build_rolename=${tdp_build}-csi-driver-role-${AWS_REGION}
...
#DELETE STACK
pei "aws cloudformation delete-stack --stack-name tdp-build-stack --region ${AWS_REGION}"
pei "aws cloudformation wait stack-delete-complete --stack-name tdp-build-stack --region ${AWS_REGION}"
echo
...
kubectl config delete-cluster ${arn}/${tdp_build}

kubectl config delete-user ${arn}/${tdp_build}
