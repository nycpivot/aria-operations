...
then
    ssh ubuntu@ec2-54-174-158-127.compute-1.amazonaws.com -i operator/keys/aria-operator-keypair-${aws_region_code}.pem -L 8001:localhost:8001 -L 9090:localhost:9090
