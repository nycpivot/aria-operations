...
then
    ssh ubuntu@ec2-3-143-238-81.us-east-2.compute.amazonaws.com -i aria-operator-setup/keys/aria-operator-keypair-${aws_region_code}.pem
...
then
    ssh ubuntu@ec2-35-93-82-66.us-west-2.compute.amazonaws.com -i aria-operator-setup/keys/aria-operator-keypair-${aws_region_code}.pem
fi
