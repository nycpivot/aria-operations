...
then
    ssh ubuntu@ec2-18-216-48-26.us-east-2.compute.amazonaws.com -i aria-operator/keys/aria-operator-keypair-${aws_region_code}.pem -L 8080:localhost:8080
...
then
    ssh ubuntu@ec2-35-93-82-66.us-west-2.compute.amazonaws.com -i aria-operator/keys/aria-operator-keypair-${aws_region_code}.pem
fi
